...
export default function DeleteNoteButton({ slug, redirectUrl = '/' }: DeleteButtonProps) {
    ...
    return (
        <button
            ...
            className="text-gray-400 hover:text-red-600 focus:outline-none cursor-pointer"
        >
